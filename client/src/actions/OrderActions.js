...
import {
  ...
  ORDER_DELETE_REQUEST, ORDER_DELETE_SUCCESS, ORDER_DELETE_FAIL, ORDER_LIST_REQUEST, ORDER_LIST_SUCCESS, ORDER_LIST_FAIL
...
export const deleteOrder = (orderId) => async (dispatch, getState) => {
  try {
    ...
    const { userSignin: { userInfo } } = getState();
    const { data } = await Axios.delete(`${process.env.REACT_APP_API_URL}/api/orders/` + orderId, {
      headers:
        { Authorization: 'Bearer ' + userInfo.token }
    });
